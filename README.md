...
The Advanced Encryption Standard (AES), also known by its oryginal name Rijndael developed by two Belgian cryptographers, Vincent Rijmen and Joan Daemen. Their combined last names to name that cipher. It's one of the most popular ciphers in the world, was published in 1997 and adopted as a federal standard in the US in  2002. All dependent data like RCON, SBOX, InvSBOX, KeySchedule is generated by functions inside cipher.py
